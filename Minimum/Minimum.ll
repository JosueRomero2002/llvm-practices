...
define void @main(){
	...
	store [10 x i32] [i32 91, i32 96, i32 48, i32 10, i32 0, i32 52, i32 9, i32 24, i32 45, i32 9], [10 x i32]* %array, align 4

	call i32(i32*, i32, i32*, i32*) @minimum(i32* %array, i32 10, i32* %pos, i32* %min)
